...
data4 <- read.csv(file="firstRun.csv", header=TRUE, sep=",")
...
points(x=data.toPlot$TimeDiffValue[101], y=data.toPlot$Velocity[101], pch=1)
points(x=data.toPlot$TimeDiffValue[131], y=data.toPlot$Velocity[131], pch=2)
points(x=data.toPlot$TimeDiffValue[161], y=data.toPlot$Velocity[161], pch=3)
points(x=data.toPlot$TimeDiffValue[191], y=data.toPlot$Velocity[191], pch=4)
points(x=data.toPlot$TimeDiffValue[221], y=data.toPlot$Velocity[221], pch=5)
...
legend("topright", inset=c(-0.22,0), legend=c("11 Degrees", "12 Degrees", "13 Degrees", "14 Degrees", "15 Degrees",
                                             "20 Degrees", "25 Degrees", "30 Degrees", "35 Degrees", "40 Degrees"), bty="n", pch=1:10, lty=1, lwd=1)
