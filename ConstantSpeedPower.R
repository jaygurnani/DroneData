...
data3.toPlotFinal <- data3.toPlot[data3.toPlot$TimeDiffValue > 25 & data3.toPlot$TimeDiffValue < 90,]
...
data4.toPlotFinal <- data4.toPlot[data4.toPlot$TimeDiffValue > 22 & data4.toPlot$TimeDiffValue < 70,]
...
data5.toPlotFinal <- data5.toPlot[data5.toPlot$TimeDiffValue > 22 & data5.toPlot$TimeDiffValue < 55,]
...
data6.toPlotFinal <- data6.toPlot[data6.toPlot$TimeDiffValue > 22 & data6.toPlot$TimeDiffValue < 53,]
...
data7.toPlotFinal <- data7.toPlot[data7.toPlot$TimeDiffValue > 25 & data7.toPlot$TimeDiffValue < 51,]
...
data8.toPlotFinal <- data8.toPlot[data8.toPlot$TimeDiffValue > 22 & data8.toPlot$TimeDiffValue < 49,]
...
data9.toPlotFinal <- data9.toPlot[data9.toPlot$TimeDiffValue > 22 & data9.toPlot$TimeDiffValue < 45,]
...
plot(y=data.toPlot$Mean, x=data.toPlot$VelocitySolid,type="p",col="black", lwd="1", xlab="Velocity (m/s)", ylab="Energy (Watts)", main="Energy consumed flying straight at constant speeds")
